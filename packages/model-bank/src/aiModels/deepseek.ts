...
const deepseekChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 1_048_576,
    description:
      'DeepSeek V4 Flash Vision Exp is the experimental multimodal vision model from DeepSeek. It matches DeepSeek V4 Flash on text Agent, reasoning, and world-knowledge tasks while adding strong visual understanding for multimodal Agent scenarios. It supports mixed text-image input via Chat Completions, Messages, and Responses APIs.',
